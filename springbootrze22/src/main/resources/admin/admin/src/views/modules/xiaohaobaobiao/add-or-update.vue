<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="消耗数量" prop="xiaohaoshuliang">
          <el-input v-model="ruleForm.xiaohaoshuliang" 
              placeholder="消耗数量" clearable  :readonly="ro.xiaohaoshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="消耗数量" prop="xiaohaoshuliang">
              <el-input v-model="ruleForm.xiaohaoshuliang" 
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shebeimingcheng = true;
          ...
          if(o=='xiaohaoshuliang'){
            this.ruleForm.xiaohaoshuliang = obj[o];
	    this.ro.xiaohaoshuliang = true;
            continue;
          }
          if(o=='dengjiriqi'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xiaohaobaobiao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiaohaobaobiaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
