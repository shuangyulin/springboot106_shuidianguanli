<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="反馈标题" prop="fankuibiaoti">
          <el-input v-model="ruleForm.fankuibiaoti" 
              placeholder="反馈标题" clearable  :readonly="ro.fankuibiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="反馈标题" prop="fankuibiaoti">
              <el-input v-model="ruleForm.fankuibiaoti" 
...
export default {
  ...
  methods: {
	...
	this.ruleForm.fankuineirong = this.ruleForm.fankuineirong.replace(reg,'../../../springbootrze22/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
