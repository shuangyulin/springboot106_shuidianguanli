<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="修复人员" prop="xiufurenyuan">
          <el-input v-model="ruleForm.xiufurenyuan" 
              placeholder="修复人员" clearable  :readonly="ro.xiufurenyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="修复人员" prop="xiufurenyuan">
              <el-input v-model="ruleForm.xiufurenyuan" 
                placeholder="修复人员" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="定期日期" prop="dingqiriqi">
          <el-input v-model="ruleForm.dingqiriqi" 
              placeholder="定期日期" clearable  :readonly="ro.dingqiriqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="定期日期" prop="dingqiriqi">
              <el-input v-model="ruleForm.dingqiriqi" 
                placeholder="定期日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="修复内容" prop="xiufuneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xiufuneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiufuneirong" label="修复内容" prop="xiufuneirong">
                    <span v-html="ruleForm.xiufuneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shebeimingcheng = true;
          ...
          if(o=='xiufurenyuan'){
            this.ruleForm.xiufurenyuan = obj[o];
	    this.ro.xiufurenyuan = true;
            continue;
          }
          if(o=='xiufuneirong'){
            this.ruleForm.xiufuneirong = obj[o];
	    this.ro.xiufuneirong = true;
            continue;
          }
          if(o=='dingqiriqi'){
            this.ruleForm.dingqiriqi = obj[o];
	    this.ro.dingqiriqi = true;
            continue;
          }
          if(o=='beizhu'){
	...
	this.ruleForm.xiufuneirong = this.ruleForm.xiufuneirong.replace(reg,'../../../springbootrze22/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `dingqixiufu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.dingqixiufuCrossAddOrUpdateFlag = false;
                  this.parent.search();
