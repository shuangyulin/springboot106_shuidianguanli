  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jihuashijian" label="计划时间" prop="jihuashijian">
              <el-input v-model="ruleForm.jihuashijian" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="修理内容" prop="xiulineirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xiulineirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiulineirong" label="修理内容" prop="xiulineirong">
                    <span v-html="ruleForm.xiulineirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jihuamingcheng = true;
          ...
          if(o=='xiulineirong'){
            this.ruleForm.xiulineirong = obj[o];
	    this.ro.xiulineirong = true;
            continue;
          }
          if(o=='jihuashijian'){
	...
	this.ruleForm.xiulineirong = this.ruleForm.xiulineirong.replace(reg,'../../../springbootrze22/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xiulijihua/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiulijihuaCrossAddOrUpdateFlag = false;
                  this.parent.search();
