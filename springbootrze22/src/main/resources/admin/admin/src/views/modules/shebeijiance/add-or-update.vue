<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="检测单号" prop="jiancedanhao">
            <el-input v-model="ruleForm.jiancedanhao" 
                placeholder="检测单号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiancedanhao" label="检测单号" prop="jiancedanhao">
              <el-input v-model="ruleForm.jiancedanhao" 
                placeholder="检测单号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="检测人员" prop="jiancerenyuan">
          <el-input v-model="ruleForm.jiancerenyuan" 
              placeholder="检测人员" clearable  :readonly="ro.jiancerenyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="检测人员" prop="jiancerenyuan">
              <el-input v-model="ruleForm.jiancerenyuan" 
                placeholder="检测人员" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='jiancedanhao'){
            this.ruleForm.jiancedanhao = obj[o];
	    this.ro.jiancedanhao = true;
            continue;
          }
	    ...
	    this.ro.shebeimingcheng = true;
          ...
          if(o=='jiancerenyuan'){
            this.ruleForm.jiancerenyuan = obj[o];
	    this.ro.jiancerenyuan = true;
            continue;
          }
          if(o=='jianceneirong'){
	...
	this.ruleForm.jianceneirong = this.ruleForm.jianceneirong.replace(reg,'../../../springbootrze22/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shebeijiance/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shebeijianceCrossAddOrUpdateFlag = false;
                  this.parent.search();
